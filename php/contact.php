...
<html lang="en">
	...
	$TO = 'thalles63@gmail.com';

	//message the subject of the email
	$SUBJECT = 'Contato do site Cervejaria St. Antonio';
	$MSG_SEND_ERROR = 'Desculpe, não conseguimos enviar esta mensagem.';
	...
	if (!$error) {
		...
		<div class="contact-f contact-success col-md-6">
			...
			<h3>Obrigado, sua mensagem foi enviada.</h3>
		...
		<div class="contact-f contact-nosuccess col-md-6">
			...
			<h3>Favor conferir seus dados e tentar novamente</h3>
